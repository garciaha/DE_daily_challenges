...
trying to set up an efficient schedule to clear this backlog. 
...
def legal_backlog(sessions, max_daily_sessions):
    pass


if __name__ == "__main__":
    assert legal_backlog({"A": 4, "B": 3, "C": 2}, 5) == 4
